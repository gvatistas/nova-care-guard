...
export const site = {
  ...
  howItWorks: {
    classified: { left: "CERTA ／ DOSSIER 04 · ARCHITECTURE", right: "BUILD-TIME → RUN-TIME" },
    eyebrow: "04 · HOW IT WORKS",
    h1: "Aerospace-grade verification, applied to medicine.",
    sub: "The same class of mathematics that proves flight-control software safe before it ever leaves the ground — turned on clinical guidelines.",
    body:
      "At build time, a language model reads a guideline once and is then put away. What remains is a static, FHIR-native artifact: a verified decision graph, signed and versioned, that runs as infrastructure. Conversational intelligence and clinical correctness become separable concerns. Your agent handles the language. Certa handles the medicine.",
    layers: [
      {
        num: "L1",
        name: "INTERFACE LAYER",
        sub: "Where your agents and applications meet Certa.",
        desc: "MCP-first. REST and SDKs for Python, TypeScript, Go. Median latency under 100 ms. Drop-in for any LLM agent, EHR workflow, or consumer surface.",
        nodes: ["MCP", "REST", "Python", "TypeScript", "Go", "CDS Hooks"],
      },
      {
        num: "L2",
        name: "ARTIFACT LAYER",
        sub: "Versioned, signed clinical decision binaries.",
        desc: "Every compiled guideline is a static FHIR-SDC artifact: cryptographically signed, version-pinned, and shippable to any SDC renderer in the world. No model in the loop at runtime.",
        nodes: ["FHIR-SDC", "ed25519 signature", "Semver", "60-day SLA"],
      },
      {
        num: "L3",
        name: "VERIFICATION LAYER",
        sub: "Mathematical guarantees, not statistical hopes.",
        desc: "Each artifact passes the same family of formal proofs that aerospace and finance use to ship safety-critical systems: exhaustiveness, determinism, reachability — verified across the entire input space, not a sampled test suite.",
        nodes: ["Exhaustiveness", "Determinism", "Reachability", "Graph proofs"],
      },
      {
        num: "L4",
        name: "INGEST LAYER",
        sub: "From the source PDF to a structured logic graph.",
        desc: "Layout-aware multimodal parsing of guideline text, tables, and flowcharts. Schema-enforced generation makes structural validity a property of construction, not of testing.",
        nodes: ["USPSTF", "ACS", "ACC/AHA", "ADA", "NICE", "CMS"],
      },
    ],
    compliance: ["HIPAA · COMPLIANT", "FHIR R4 · NATIVE", "HL7 CDS HOOKS · SUPPORTED", "SOC 2 TYPE II · IN PROGRESS"],
    closer:
  ...
  segments: {
    classified: { left: "CERTA ／ DOSSIER 06 · TARGET CUSTOMERS", right: "DEPLOYMENT SURFACES" },
    eyebrow: "06 · TARGET CUSTOMERS",
    h1: "One artifact. Six places it gets used.",
    sub: "Each surface ships the same compiled object. The pitch — and the operating impact — is different.",
    items: [
      {
        id: "frontier-labs",
        name: "Frontier Labs",
        accent: "hsl(var(--signal-blue))",
        valueProp: "Replace probabilistic medical reasoning with a deterministic tool call. Your model handles language; Certa returns a verified recommendation, with provenance, in under 100 ms.",
        operatingImpact: "Removes the medical-device exposure from your consumer health surface and collapses the inference cost of every clinical turn into a single deterministic call.",
        accounts: "OpenAI · Anthropic · Google DeepMind · xAI",
      ...
      },
      {
        ...
        valueProp: "Ship clinical decision support inside your product without staffing a clinical team. FHIR-native artifact embeds in any EHR workflow.",
        operatingImpact: "Cuts clinical-engineering headcount, shortens hospital procurement by quarters, and moves liability for guideline correctness off your balance sheet.",
        accounts: "Abridge · OpenEvidence · Hippocratic · Glass · Ambience · Nabla · Elation",
        stat: { value: "<100 ms", label: "Median latency" },
      },
      {
        id: "consumer-health",
        name: "Consumer Health Platforms",
        accent: "hsl(var(--seg-cyan))",
        valueProp: "Turn passive measurement into actionable, guideline-backed recommendations — without raising medical-device exposure.",
        operatingImpact: "Apple, Oura, and Whoop measure. Certa lets you tell a user what to do about it, with a citation a regulator will accept.",
      ...
      },
      {
        id: "payers",
        name: "Payers",
        accent: "hsl(var(--seg-brown))",
        valueProp: "Bend the claims curve through upstream detection. Population-level guideline bundles deploy through your member portal or care-management workflow.",
        operatingImpact: "Early detection at $4.2K versus late-stage treatment at $288K+. Our T-MSIS analysis identifies $320–450M in annual Medicaid billing gaps from missed USPSTF services.",
      ...
      },
      {
        ...
        accent: "hsl(var(--seg-amber))",
        valueProp: "Compilation as a service. Your narrative guideline becomes a verified, deployable artifact carrying your imprimatur.",
        operatingImpact: "Closes the adherence gap from roughly half to over ninety percent — without your team writing a line of code.",
      ...
      },
      {
        ...
        accent: "hsl(var(--seg-slate))",
        valueProp: "RHTP-aligned infrastructure. Certa artifacts are exactly the deliverable the statute names: AI-enabled, evidence-based, auditable preventive care.",
        operatingImpact: "Cooperative-agreement and SBIR/STTR procurement paths. ISO 27001 and FedRAMP Moderate on the roadmap. Air-gap deployable on day one.",
        accounts: "CMS · CDC · VA · IHS · State health departments · IRAP (CA)",
