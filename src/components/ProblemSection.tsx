...
const ProblemSection = () => {
  ...
  return (
    <section ref={ref} className="relative py-16 md:py-24 texture-crosshatch">
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 md:px-8">
        ...
        <motion.p
          ...
          className="text-gray-300 text-lg md:text-xl font-light mt-5 max-w-2xl leading-relaxed"
        >
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-px bg-white/[0.06]">
          {[
            ...
            >
              ...
              <div className="text-gray-300 text-base font-light mt-3 leading-relaxed">
                {stat.desc}
              </div>
            </motion.div>
          ))}
