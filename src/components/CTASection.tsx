    ...
    <section id="contact" ref={ref} className="relative py-24 md:py-40 overflow-hidden">
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 md:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} className="max-w-3xl">
          <h2 className="text-white text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-mono font-light leading-[1.1] tracking-[-0.02em] mb-8 md:mb-10">
            Probabilistic once.
            <br />
            <span className="text-accent">Deterministic forever.</span>
          </h2>

          <p className="text-gray-400 text-base md:text-lg font-light leading-relaxed mb-10 md:mb-14 max-w-xl">
      ...
      <motion.footer initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ delay: 0.5 }} className="mt-32 md:mt-40 border-t border-white/[0.06]">
        <div className="max-w-[1400px] mx-auto px-6 md:px-8 py-10 flex flex-col sm:flex-row items-center justify-between gap-6">
