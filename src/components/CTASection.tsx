    ...
    <section id="contact" ref={ref} className="relative py-40">
      <div className="relative max-w-[1400px] mx-auto px-6 flex flex-col items-center text-center">
        ...
        >
          <a
            href="#"
            className="font-mono text-sm tracking-[0.08em] uppercase bg-teal text-deep-field px-10 py-4 hover:bg-[#6FFFD4] transition-all duration-200 hover:shadow-[0_4px_16px_rgba(74,237,196,0.2)]"
          ...
          <a
            href="#"
            className="font-mono text-sm tracking-[0.08em] uppercase text-teal border border-teal px-10 py-4 hover:bg-teal/[0.08] transition-all duration-200"
            style={{ borderRadius: "6px" }}
          >
            Read the Whitepaper
          </a>
      ...
      >
        <div className="max-w-[1400px] mx-auto px-6 py-12 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            ...
            <div className="font-mono text-warm-gray text-xs mt-1">
