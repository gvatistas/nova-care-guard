...
const segments = [
  {
    ...
    useCase: "A 12-hospital network deploys Medient's lung cancer screening artifact. Within 90 days, every eligible patient across all facilities is automatically flagged.",
    metrics: [
  ...
  },
  {
    ...
    description: "Government health agencies have clear mandates and dedicated funding for evidence-based prevention but lack the infrastructure to operationalize clinical guidelines at population scale.",
    useCase: "A federal agency deploys compiled USPSTF screening guidelines across 200+ community health centers. Every recommendation is traceable. Every decision is auditable.",
    metrics: [
  ...
  },
  {
    ...
    description: "CMS quality programs require precise alignment between clinical actions and reporting measures. Medient's compiled artifacts map directly to CMS quality measures — enabling automated compliance.",
    useCase: "A Medicaid managed care organization integrates Medient artifacts to automate HEDIS measure compliance. Guideline adherence data flows directly into quality reporting.",
    metrics: [
  ...
  },
  {
    ...
    description: "For payers, every missed screening is a future catastrophic claim. Medient enables population-level guideline deployment on a per-member-per-month basis.",
    useCase: "A regional health plan deploys Medient's colorectal cancer screening artifact across 800K members. Within one year, screening rates increase 38%.",
    metrics: [
  ...
  },
  {
    ...
    description: "Frontier labs, medical scribes, and AI wrappers need clinical decision logic but can't afford the liability of probabilistic inference. Medient provides a verified clinical logic layer through an MCP API.",
    useCase: "A medical AI scribe integrates Medient's API. When a physician dictates a patient encounter, the scribe automatically surfaces relevant screening recommendations from formally verified artifacts.",
    metrics: [
  ...
  },
  {
    ...
    description: "Medical societies spend years developing evidence-based guidelines that languish as PDFs. Medient compiles your narrative guidelines into verified, deployable decision artifacts.",
    useCase: "A major cardiology society partners with Medient to compile their hypertension guidelines. Within 6 months, participating health systems report near-universal adherence.",
    metrics: [
...
const SegmentsSection = () => {
  ...
  return (
    <section ref={ref} className="relative py-24 md:py-40" onMouseMove={handleSectionMouse}>
      {/* Ambient glow that shifts color based on hovered segment */}
      <div
            ...
            >
              <div className="py-6 md:py-8 px-3 md:px-6 grid grid-cols-12 gap-4 md:gap-6 items-center">
                ...
                <div className="col-span-5 md:col-span-4">
                  <h3
                    className="font-mono text-base md:text-lg font-light transition-colors duration-300"
                    style={{ color: expanded === i || hoveredIdx === i ? `hsl(${seg.accentHsl})` : "white" }}
                  >
                    {seg.name}
                  </h3>
                </div>
                ...
                <div className="px-3 md:px-6 pb-8 md:pb-12">
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pl-0 md:pl-[calc(8.333%+1.5rem)]">
                    <div className="md:col-span-6">
                      ...
                      <div
                        className="pl-5 py-2"
                        style={{ borderLeft: `2px solid hsla(${seg.accentHsl} / 0.3)` }}
                      >
