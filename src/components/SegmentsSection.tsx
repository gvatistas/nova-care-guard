...
const segments = [
  { name: "Federally Qualified Health Centers", abbr: "FQHCs", stat: "1,400+ eligible facilities", desc: "Deploy verified clinical decision artifacts across the FQHC network — the largest safety-net infrastructure in the U.S." },
  { name: "Rural Health Clinics", abbr: "RHCs", stat: "4,700+ eligible facilities", desc: "Air-gapped, low-bandwidth deployment for clinics operating in connectivity-constrained environments." },
  { name: "Tribal Health Programs", abbr: "IHS / Tribal", stat: "574 federally recognized tribes", desc: "Culturally-aligned clinical intelligence for Indian Health Service and tribal health organizations." },
  { name: "Community Health Centers", abbr: "CHCs", stat: "31M+ patients served annually", desc: "Network-wide screening adherence across multi-site community health organizations." },
];
            ...
            return (
              <motion.div
                ...
                style={{
                  ...
                  boxShadow: isHovered ? "0 0 30px rgba(255,255,255,0.05), inset 0 0 20px rgba(255,255,255,0.02)" : "none",
                ...
                <div className="p-6 md:p-8 flex items-start gap-5">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-baseline gap-3 mb-1.5">
                      <h3 className="font-mono font-light tracking-wide"
                        style={{ color: isHovered ? "white" : "rgba(255,255,255,0.85)", transition: "color 300ms ease", fontSize: "1.125rem" }}>
                        {seg.name}
                      </h3>
                    ...
                    <p className="leading-relaxed mb-3" style={{ color: "rgba(255,255,255,0.6)", fontSize: "1rem" }}>{seg.desc}</p>
                    ...
                    <div className="font-mono tracking-[0.1em] flex items-center gap-2"
                      ...
                      <span className="w-1 h-1 rounded-full animate-pulse" style={{ backgroundColor: "#10b981" }} />
                      {seg.stat}
                    </div>
                  </div>
                </div>
